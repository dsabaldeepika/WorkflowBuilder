...
// Zod schemas for messaging
export const messagingIntegrationInsertSchema = createInsertSchema(
  messagingIntegrations
);
export const messageInsertSchema = createInsertSchema(messages);
export const messageTemplateInsertSchema = createInsertSchema(messageTemplates);
export const webhookEventInsertSchema = createInsertSchema(webhookEvents);
...
export type InsertMessagingIntegration = z.infer<
  typeof messagingIntegrationInsertSchema
>;
export type InsertMessage = z.infer<typeof messageInsertSchema>;
export type InsertMessageTemplate = z.infer<typeof messageTemplateInsertSchema>;
